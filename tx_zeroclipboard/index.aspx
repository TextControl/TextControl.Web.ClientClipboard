        ...
        <form runat="server">
            ...
            <script type="text/javascript">
                ...
                function addButtonsToDOM() { 
                    sClipboardBtn = '<div onclick="toggleClipboardDropDown()" id="zeroClipboardCopy" class="ribbon-button ribbon-button-big"><div class="ribbon-button-big-image-container"><img src="images/clipboard_copy_client.png" class="ribbon-button-big-image" /></div><div class="ribbon-button-big-label-container"><p class="ribbon-button-label"><span class="ribbon-button-label-text">Copy to Client<br /> Clipboard</span><span class="drop-down-arrow-large"> ▼</span></p></div></div></div>';
